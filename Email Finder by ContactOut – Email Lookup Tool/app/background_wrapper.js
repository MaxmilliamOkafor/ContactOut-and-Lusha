// OutreachPro Background Wrapper
// Loads the original ContactOut background and adds OutreachPro message handlers

// Import the original background (side-effect execution)
// The webpack bundle is a self-executing function that works in module context
try {
  await import('./background.js');
} catch (e) {
  console.warn('[OutreachPro] Original background import notice:', e.message);
}

// ── OutreachPro Message Handlers ────────────────────────────────
...
console.log('[OutreachPro] Background handlers registered ✨');
